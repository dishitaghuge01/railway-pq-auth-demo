...
def run_keygen(force: bool = False, rotate: bool = False) -> None:
    ...
    _print_separator()
    print(f"Algorithm : Falcon-padded-512 (FIPS 206 / FN-DSA, level 1, 128-bit PQ security)")
    print(f"  Security  : 128-bit post-quantum (NIST FN-DSA, lattice-based, hash-and-sign)")
